...
public class Config {
    ...
    public static final String API_KEY = "cVdfg41aZx3F1buYhg6iOlk2dAz";
    public static String BASE_URL = "http://push.jigdev.wtf/push/";
    ...
    //CoronaVirus API
    public static String CORONA_VIRUS_ALL = "https://coronavirus-19-api.herokuapp.com/all";
    public static String CORONA_VIRUS_ONE_COUNTRY = "https://coronavirus-19-api.herokuapp.com/countries/";
    public static String CORONA_VIRUS_ALL_COUNTRIES_WEB = BASE_URL + "countries.php";
    public static String CORONA_VIRUS_ALL_ONE_COUNTRY_WEB = BASE_URL + "one_country.php?country=";
