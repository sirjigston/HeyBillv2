package com.jigwtf.heybill.utils;
...
public class AppController extends Application
{
	...
	private String reward_coin_banner_ad_exp, reward_coin_interstitial_ad_exp, reward_coin_rewarded_ad_exp, reward_coin_native_ad_exp, reward_coin_play_game_exp, reward_coin_banner_ad_coin_req, reward_coin_interstitial_ad_coin_req,
            ...
            reward_coin_price_of_each_coin, reward_coin_watching_video_exp, reward_coin_watching_video, setting_emergency_call, setting_default_country;

    public String getSetting_emergency_call() {
        return setting_emergency_call;
    }

    public void setSetting_emergency_call(String setting_emergency_call) {
        this.setting_emergency_call = setting_emergency_call;
    }

    public String getSetting_default_country() {
        return setting_default_country;
    }

    public void setSetting_default_country(String setting_default_country) {
        this.setting_default_country = setting_default_country;
    }
