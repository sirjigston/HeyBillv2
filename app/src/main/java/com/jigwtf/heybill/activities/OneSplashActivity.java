...
import com.jigwtf.heybill.BuildConfig;
            ...
            public void onResponse(JSONArray response) {
                for (int i = 0; i < response.length(); i++) {
                    try {
                        ...
                        ((AppController) OneSplashActivity.this.getApplication()).setSetting_emergency_call(jsonObject.getString("setting_emergency_call"));
                        ((AppController) OneSplashActivity.this.getApplication()).setSetting_default_country(jsonObject.getString("setting_default_country"));
