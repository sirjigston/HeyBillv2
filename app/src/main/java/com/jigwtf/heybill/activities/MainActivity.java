...
import com.jigwtf.heybill.fragments.AboutFragment;
import com.jigwtf.heybill.fragments.CategoryFragment;
import com.jigwtf.heybill.fragments.MainFragment;
import com.jigwtf.heybill.fragments.ProfileFragment;
import com.jigwtf.heybill.fragments.SearchFragment;
import com.jigwtf.heybill.utils.AppController;
import com.jigwtf.heybill.utils.PrefManager;

import io.github.inflationx.viewpump.ViewPumpContextWrapper;
import com.jigwtf.heybill.R;

import com.jigwtf.heybill.fragments.WebViewFragment;
        ...
        implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent intent = new Intent(Intent.ACTION_DIAL, Uri.fromParts("tel", ((AppController) MainActivity.this.getApplication()).getSetting_emergency_call(), null));
            ...
            //Pass variable to fragment
            Bundle bundle = new Bundle();
            String theTitle = getString(R.string.nav_source);
            String theSubTitle = getString(R.string.txt_source_and_references);
