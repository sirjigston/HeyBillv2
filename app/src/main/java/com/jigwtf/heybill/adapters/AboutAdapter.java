package com.jigwtf.heybill.adapters;
...
import com.jigwtf.heybill.models.AboutModel;
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (thePosition == 6) //Privacy Policy and Terms
                    {
                        ...
                        //Pass variable to fragment
                        Bundle bundle = new Bundle();
                        String theTitle = context.getString(R.string.nav_source);
                        String theSubTitle = context.getString(R.string.txt_source_and_references);
